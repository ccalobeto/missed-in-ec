...
import * as chromatic from 'https://cdn.skypack.dev/d3-scale-chromatic@3'
...
export function choropleth (idContainer, data, {
  ...
  const color = scale.scaleSequential(domain, chromatic.interpolateReds)
